...
(facts
  ...
  (fact "East"
        (move-rover {:x 0 :y 0 :heading "E"} "L") => {:x 0 :y 0 :heading "N"}))
(facts
  "Allow Mars Rover to rotate to right from"
  (fact "North"
        (move-rover {:x 0 :y 0 :heading "N"} "R") => {:x 0 :y 0 :heading "E"})
  (fact "West"
        (move-rover {:x 0 :y 0 :heading "W"} "R") => {:x 0 :y 0 :heading "N"})
  (fact "South"
        (move-rover {:x 0 :y 0 :heading "S"} "R") => {:x 0 :y 0 :heading "E"})
  (fact "East"
        (move-rover {:x 0 :y 0 :heading "E"} "R") => {:x 0 :y 0 :heading "S"}))
